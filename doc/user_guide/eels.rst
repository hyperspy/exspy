...
As an alternative, one can use the `Dirac GOS <https://arxiv.org/abs/2405.10151>`_ to include the relativistic effects using the Dirac solution, which can be downloaded from Zenodo: `doi:10.5281/zenodo.12751756 <https://zenodo.org/record/12751756>`_.
