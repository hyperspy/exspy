...
ENERGY_RANGE_PARAMETER = """energy_range : list or tuple of length 2
        Define the start and the end of the x-ray energy to consider.
        X-ray energy outside the range will be ignored. If ``None``,
        all x-ray energy are considered. Default is None."""
