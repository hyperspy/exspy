...
class TestWeightToFromAtomic:
    def setup_method(self, method):
        ...
        atomic_weight = np.array(
            [
                material.elements[element].General_properties.atomic_weight
...
def test_density_of_mixture():
    ...
    densities = np.array(
        [
            material.elements[element].Physical_properties.density_gcm3
